        ...
        <div className={`flex flex-col justify-center w-full px-4 py-2`}>
            ...
            <div className={`flex flex-col justify-start w-full gap-2 pb-12 bg-skin-theme-body-50`}>
                ...
                <div className={'flex flex-row justify-end gap-3 mt-4'}>
                    ...
                    <button
                        className={'bg-skin-theme-500 w-28 h-12 text-lg rounded border-[1px] border-skin-theme-500/40 text-skin-theme-font-900 font-semibold'}>App
                        Store
                    </button>
                </div>
            </div>
            <div className={'grid grid-cols-1 grid-rows-1 tablet:grid-cols-2 tablet:gap-8 gap-4 pt-2 py-6'}>
                <div className={'bg-skin-theme-body-100/40 border border-skin-theme-body-600/40 rounded-sm text-skin-theme-font-50 mx-auto'}>
                    <div className={'flex flex-col justify-center gap-3 px-1 py-4 max-w-screen-smPhone'}>
                        ...
                        <h1 className={'text-4xl text-skin-theme-500 font-bold text-center mb-1'}>$29<span
                            className={'text-lg text-skin-theme-font-500'}> / month</span></h1>
                        ...
                        <div className={'mt-4 w-full flex flex-row justify-center items-center'}>
                            <button
                                className={'bg-skin-theme-500 w-48 h-12 text-lg rounded border-[1px] border-skin-theme-500/40 text-skin-theme-font-900 font-semibold'}>Get
                                Started
                            </button>
                        </div>
                ...
                <div className={'bg-skin-theme-body-100/40 border border-skin-theme-body-600/40 rounded-sm text-skin-theme-font-50 mx-auto'}>
                    <div className={'flex flex-col justify-center gap-3 px-1 py-4 max-w-screen-smPhone'}>
                        ...
                        <div className={'mt-4 w-full flex flex-row justify-center items-center'}>
                            <button
                                className={'bg-skin-theme-500 w-48 h-12 text-lg rounded border-[1px] border-skin-theme-400/40 text-skin-theme-font-900 font-semibold'}>Get
                                Started
                            </button>
                        </div>
